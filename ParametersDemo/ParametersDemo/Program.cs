/*Parameters Demo (learn to use parameters in C#)
 Programmer: Tucker Anastasio
 Date 5/20/2026*/
...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        // Optional parameter pass by position
        ...
        Console.WriteLine("\nTestMultiple set 1 and 3");
        TestMultiple(1, cValue: 3);

        // Overload test string method
        Console.WriteLine("\nTest overload method with string");
